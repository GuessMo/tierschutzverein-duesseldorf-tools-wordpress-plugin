<?php
// AI Abilities — raw definitions (name => wp_register_ability args).
// Kept separate from registration so the admin toggle page can list every
// ability (label, description, annotations) regardless of enabled state.

if (!defined('ABSPATH')) exit;

function tsvd_tools_ai_get_ability_definitions() {
    $animal_object = array(
        'type'       => 'object',
        'properties' => array(
    ...
    return array(
        ...
        'tsv-tools/create-animals-bulk' => array(
        ...
        'tsv-tools/create-missing-form' => array(
        ...
        'tsv-tools/set-missing-page' => array(
        ...
        'tsv-tools/set-animal-interest-seed' => array(
        ...
        'tsv-tools/add-applicant-fields-to-form' => array(
        ...
        'tsv-tools/rest-list-routes' => array(
        ...
        'tsv-tools/seed-demo-stats' => array(
