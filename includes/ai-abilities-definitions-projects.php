        ...
        'tsv-tools/add-project-milestone' => array(
            ...
            'input_schema'        => array(
                ...
                'properties' => array(
                    ...
                    'image'        => array('type' => 'integer', 'description' => 'Veraltet: einzelne Attachment-ID. Bevorzugt images verwenden.'),
                    'images'       => array('type' => 'array', 'items' => array('type' => 'integer'), 'description' => 'Attachment-IDs fuer die Bild-Galerie (mehrere moeglich, erstes = Titelbild).'),
        ...
        'tsv-tools/update-project-milestone' => array(
            ...
            'input_schema'        => array(
                ...
                'properties' => array(
                    ...
                    'image'        => array('type' => 'integer', 'description' => 'Veraltet: einzelne Attachment-ID. Bevorzugt images verwenden.'),
                    'images'       => array('type' => 'array', 'items' => array('type' => 'integer'), 'description' => 'Neue Bild-Galerie als Attachment-IDs (ersetzt die bisherige Galerie, erstes = Titelbild).'),
