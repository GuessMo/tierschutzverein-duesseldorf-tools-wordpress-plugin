...
function tsvd_tools_ai_get_ability_definitions_content() {
    return array(
        'tsv-tools/create-update' => array(
            ...
            'description'         => __('Legt einen Website-Update-Eintrag (tsvd_update) an — Changelog/Dashboard und Quelle des dynamischen Newsletter-Blocks. visibility intern|extern (extern = auch Startseite), status draft|publish.', 'tsv-tools'),
            ...
            'input_schema'        => array(
                ...
                'properties' => array(
                    ...
                    'visibility' => array('type' => 'string', 'enum' => array('intern', 'extern'), 'description' => 'Standard intern.'),
