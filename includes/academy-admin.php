...
function tsvd_academy_enqueue_assets() {
	wp_enqueue_style( 'tsvd-academy', TSVD_TOOLS_URL . 'assets/academy.css', array( 'tsvd-dashboards' ), TSVD_TOOLS_ASSET_VERSION );
	wp_enqueue_style( 'tsvd-academy-cards', TSVD_TOOLS_URL . 'assets/academy-cards.css', array( 'tsvd-academy' ), TSVD_TOOLS_ASSET_VERSION );
	if ( ! tsvd_academy_requested_lesson_id() ) {
		return;
	}
	wp_enqueue_style( 'wp-block-library' );
	wp_enqueue_style( 'tsvd-academy-article', TSVD_TOOLS_URL . 'assets/academy-article.css', array( 'tsvd-academy' ), TSVD_TOOLS_ASSET_VERSION );
}
