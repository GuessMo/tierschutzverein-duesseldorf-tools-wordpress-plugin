...
function tsvd_r301_render_edit() {
    ...
    echo '<form method="post" action="' . esc_url( admin_url( 'admin-post.php' ) ) . '">'
        ...
        . '<tr><th><label for="r301-domain">Domain</label></th><td><input name="domain" id="r301-domain" class="regular-text" value="' . esc_attr( $r['domain'] ) . '" required></td></tr>'
        . '<tr><th><label for="r301-source">Quelle (Pfad)</label></th><td><input name="sourcePath" id="r301-source" class="regular-text" value="' . esc_attr( $r['sourcePath'] ) . '" placeholder="/de/alte-url" required></td></tr>'
        . '<tr><th><label for="r301-target">Ziel</label></th><td><input name="target" id="r301-target" class="regular-text" value="' . esc_attr( $r['target'] ) . '" placeholder="https://tierschutzverein-duesseldorf.de/neue-url/"><p class="description">Bei 410 ohne Ziel.</p></td></tr>'
        . '<tr><th><label for="r301-status">Status</label></th><td><select name="statusCode" id="r301-status">' . tsvd_r301_status_options( (int) $r['statusCode'] ) . '</select></td></tr>'
