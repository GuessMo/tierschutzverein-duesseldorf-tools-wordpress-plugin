...
function tsvd_render_anfragen_imap_settings_tab() {
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td><input type="text" id="tsvd_anfragen_imap_username" name="tsvd_anfragen_imap_username" class="regular-text" value="<?php echo esc_attr($s['username']); ?>" /></td>
        </tr>
        <tr>
        ...
        <?php tsvd_halter_render_responsible_rows(); ?>
        <tr>
